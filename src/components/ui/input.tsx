  ...
  return (
    <input
      ...
      className={cn(
        ...
        "hover:border-[#a0a7b0]",
        "focus-visible:border-ring focus-visible:ring-ring/20 focus-visible:ring-[3px] focus-visible:shadow-lg focus-visible:scale-[1.01]",
        "placeholder:transition-all placeholder:duration-200 focus-visible:placeholder:text-muted-foreground/60",
